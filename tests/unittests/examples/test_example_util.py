...
def test_example_conversion_prefix_insertion():
    ...
    output_content = [
        types.Content(
            role="model",
            parts=[types.Part(text="test_output_1")]
        ),
        types.Content(
            role="user",
            parts=[types.Part(text="test_output_2")]
        ),
        types.Content(
            role="model",
            parts=[types.Part(text="test_output_3")]
        )
    ]
    test_example = example.Example(
        input=input_content,
...
def test_example_conversion_output_clumping():
    ...
    output_content = [
        ...
        types.Content(
            role="user",
            parts=[types.Part(text="test_output_4")]
        )
    ]
    test_example = example.Example(
        input=input_content,
...
def test_example_conversion_with_function_call(model):
    ...
    test_function_call = types.FunctionCall(
        name="test_function",
        args={
            "test_string_argument": "test_value",
            "test_int_argument": 1
        }
    )
    input_content = types.Content(
    ...
    expected_output = (
        ...
        f"test_function(test_string_argument='test_value', test_int_argument=1)"
